...
def FATArea() :
	...
	Non_Data_Cluster = whole_data.read(0x08) # Cluster 0 & 1
	Data_Cluster = whole_data.read(sizeFAT-0x08) # FAT Size - (Cluster 0's + 1's Size)
...
def signature_print(sig) : # file signature is written by Little endian
	...
	"0xa1a0a0d474e5089" : "png (Portable Network Graphic)", "0x4143435300000011" : "pf (Windows Prefetch File)",
